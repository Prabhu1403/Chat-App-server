...
export const updateLastSeen = async (req: Request, res: Response) => {
    try {
        ...
        const logoutTime = new Date().toLocaleString("en-IN", { timeZone: "Asia/Kolkata", month: "short", day: "numeric", year: "numeric", hour: "numeric", minute: "2-digit", hour12: true });
        (user as any).lastSeen = logoutTime;
